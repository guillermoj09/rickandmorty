...
public interface CharactersApi {
    ...
    @ApiOperation(value = "", notes = "Save a list of characters", response = Void.class, tags={ "characters", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> postCharacters(@ApiParam(value = "All Characters to save."  ) @RequestBody PostCharactersRequest characters);
