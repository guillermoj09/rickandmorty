...
public class ClientCharacterToCharacterMapper {
  ...
  public Character mappingFromToCharacter(ClientCharacter clientCharacter) {
    ...
    return Character.builder()
        ...
        .withStatus(clientCharacter.getStatus())
        .withType(clientCharacter.getType())
        .withEpisode(clientCharacter.getEpisode())
        .withOrigin(clientCharacterOriginToOrigin(clientCharacter))
        .build();
  }


  private Location clientCharacterOriginToOrigin(ClientCharacter clientCharacter) {
    Location origin = new Location();
    origin.setUrl(clientCharacter.getOrigin().getUrl());
    return origin;
  }
