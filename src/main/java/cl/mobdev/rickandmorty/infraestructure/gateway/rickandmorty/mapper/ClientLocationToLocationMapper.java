...
public class ClientLocationToLocationMapper {
  ...
  public Location mappingFromLocation(ClientLocation clientLocation) {
    return Location.builder().withId(clientLocation.getId())
            .withName(clientLocation.getName())
            .withType(clientLocation.getType())
            .withDimension(clientLocation.getDimension())
            .withUrl(clientLocation.getUrl())
            .withResidents(clientLocation.getResidents())
            .build();
  }
