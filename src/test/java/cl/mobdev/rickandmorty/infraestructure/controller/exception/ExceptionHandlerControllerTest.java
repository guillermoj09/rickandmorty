...
class ExceptionHandlerControllerTest {
  ...
  @Test
  void should_return_bad_request_server_error_status() {
    String messageExpected = "some error";
    HttpStatus statusExpected = HttpStatus.BAD_REQUEST;

    //GIVEN
    NoSaveException runtimeException = new NoSaveException("some error");
  ...
  @Test
  void should_return_internal_server_when_character_exception() {
    String messageExpected = "some error";
    HttpStatus statusExpected = HttpStatus.INTERNAL_SERVER_ERROR;

    //GIVEN
    CharacterException runtimeException = new CharacterException("some error");
