...
class ClientCharacterToCharacterMapperTest {
  ...
  @Test
  void should_return_a_Character_object() {
    final int idExpected = 1;

    //GIVEN
    ClientCharacter oneObjectOfClientCharacter = ClientCharacterMock.build_only();

    //WHEN
    Character response = this.mapper.mappingFromToCharacter(oneObjectOfClientCharacter);
